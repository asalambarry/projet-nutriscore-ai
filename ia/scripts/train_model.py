...
def main():
    ...
    try:
        ...
        df = pd.read_csv('../data/produits_alimentaires_nettoyes.csv')
        print(f"Données chargées: {len(df)} produits")
    except FileNotFoundError:
        print("Fichier '../data/produits_alimentaires_nettoyes.csv' non trouvé")
        print("Assurez-vous que le fichier existe dans le dossier ia/data/")
        return False
    ...
    joblib.dump(model, '../models/nutriscore_model.joblib')
    joblib.dump(scaler, '../models/nutriscore_scaler.joblib')
    joblib.dump(oe, '../models/nutriscore_encoder.joblib')
    ...
    print("   - ../models/nutriscore_model.joblib")
    print("   - ../models/nutriscore_scaler.joblib")
    print("   - ../models/nutriscore_encoder.joblib")
    ...
    try:
        ...
        model_test = joblib.load('../models/nutriscore_model.joblib')
        scaler_test = joblib.load('../models/nutriscore_scaler.joblib')
        encoder_test = joblib.load('../models/nutriscore_encoder.joblib')
